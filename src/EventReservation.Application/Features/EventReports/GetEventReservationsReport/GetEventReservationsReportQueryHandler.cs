...
public sealed class GetEventReservationsReportQueryHandler
    : IQueryHandler<GetEventReservationsReportQuery, IReadOnlyList<EventReservationReportResponse>>
{
    private readonly ICurrentUserService _currentUserService;
    private readonly IEventRepository _eventRepository;
    private readonly IEventReportRepository _eventReportRepository;

    public GetEventReservationsReportQueryHandler(
    ...
    public async Task<IReadOnlyList<EventReservationReportResponse>> Handle(GetEventReservationsReportQuery query, CancellationToken cancellationToken)
    {
        ...
        return await _eventReportRepository.GetReservationsByEventIdAsync(query.EventId, cancellationToken);
    }
}